...
const App: React.FC = () => {
  ...
  const canExtend =
    ...
    lastConfig?.aspectRatio === AspectRatio.LANDSCAPE;
  ...
  return (
    <div className="h-screen bg-black text-gray-200 flex flex-col font-sans overflow-hidden">
      ...
      <header className="py-6 flex flex-col items-center justify-center px-8 relative z-10">
        <h1 className="text-4xl sm:text-5xl font-semibold tracking-wide text-center bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-2">
          Phoenix Studio
        </h1>
        <p className="text-sm sm:text-base text-gray-400 text-center transition-opacity duration-300">
          AI 자동화 시스템 및 MCP 멀티 에이전트 솔루션
        </p>
      </header>
          ...
          <>
            <div className="flex-grow flex items-center justify-center">
              <div className="relative text-center">
                <h2 className="text-2xl sm:text-3xl text-gray-600 flex flex-col items-center gap-2">
                  <span>Type in the prompt box to start</span>
                  <span className="text-lg sm:text-xl text-gray-500">(프롬프트 창에 입력하여 시작하세요)</span>
                </h2>
      ...
      <footer className="w-full py-4 px-4 text-center text-xs sm:text-sm text-gray-500 border-t border-gray-800 bg-black/50 z-10 relative">
        <p>
          &copy; 2026 Phoenix AI. AI가 사람의 가능성을 확장합니다. | n8n 기반 노코드 AI 자동화 | RAG &amp; 다중 에이전트 기술
        </p>
      </footer>
    </div>
  );
