...
const PromptForm: React.FC<PromptFormProps> = ({
  ...
  const promptPlaceholder = {
    [GenerationMode.TEXT_TO_VIDEO]: 'Describe the video you want to create... (생성할 비디오를 설명하세요...)',
    [GenerationMode.FRAMES_TO_VIDEO]:
      'Describe motion between start and end frames (optional)... (시작 프레임과 끝 프레임 사이의 움직임을 설명하세요 (선택사항)...)',
    [GenerationMode.REFERENCES_TO_VIDEO]:
      'Describe a video using reference images... (참조 이미지를 사용하여 비디오를 설명하세요...)',
    [GenerationMode.EXTEND_VIDEO]: 'Describe what happens next (optional)... (다음에 일어날 일을 설명하세요 (선택사항)...)',
  }[generationMode];
      ...
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <div className="flex items-end gap-2 bg-[#1f1f1f] border border-gray-600 rounded-2xl p-2 shadow-lg focus-within:ring-2 focus-within:ring-indigo-500">
          <div className="relative" ref={modeSelectorRef}>
            ...
            {isModeSelectorOpen && (
              <div className="absolute bottom-full mb-2 w-max min-w-[300px] bg-[#2c2c2e] border border-gray-600 rounded-lg shadow-xl overflow-hidden z-30">
